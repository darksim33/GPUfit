#ifndef GPUFIT_TRIEXP_T1_STEAM_CUH_INCLUDED
#define GPUFIT_TRIEXP_T1_STEAM_CUH_INCLUDED
...
__device__ void calculate_triexp_t1_steam(
    ...
    std::size_t const user_info_size)
{
    ...
    /* value
    y = (a*exp(-bx) + c*exp(-dx) + e*exp(-fx))*(1 - exp(-TR/g))*exp(-TM/g)
